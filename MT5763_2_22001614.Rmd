...
The greatest difference between the expected and the average observed win rate can be seen at $p = 40%$, with a difference of -18% from the expected winning rate. If we apply the logic from the example above, the probability of no wins at all is $(1-0.4)^3 = 0.216$, implying a difference of -0.4 in 22 out of 100 tournament compared to the expected win rate.\
\
References:\
